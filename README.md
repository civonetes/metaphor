...
| environment | url                                          |
| ----------- | -------------------------------------------- |
| development | `https://metaphor-development.demo.civonetes.com` |
| staging     | `https://metaphor-staging.demo.civonetes.com`     |
| production  | `https://metaphor-production.demo.civonetes.com`  |
